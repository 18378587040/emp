...
<!--                    <el-input style="width:250px" v-model="TransDepartForm.afterDepart" />-->
                ...
                <el-form-item label="调动后">
                    <el-popover
                        ...
                        <div slot="reference" style="width: 240px;display: inline-flex;border: 1px solid #dedede;
                    height: 35px;border-radius: 5px;cursor: pointer" @click="showDepart2">{{inputDepartName2}}</div>
                    </el-popover>
    ...
    export default {
        ...
        methods: {
            ...
            handleNodeClick2(data) {
                this.TransDepartForm.beforeDepart = data.name;
                this.inputDepartName2 = data.name;
                this.TransDepartForm.departId2 = data.id;
                this.visible2 = !this.visible2;
            },
            showDepart(){
            ...
            handleNodeClick(data) {
                this.TransDepartForm.afterDepart = data.name;
            ...
            openModel(TransDepart) {
                if (TransDepart != null) {
                    console.log(TransDepart)
                    this.TransDepartForm = JSON.parse(JSON.stringify(TransDepart));
                    this.inputDepartName = TransDepart.afterDepart;
                    this.inputDepartName2 = TransDepart.beforeDepart;
