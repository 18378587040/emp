<template>
    <el-card class="main-card">
        ...
        >
            ...
            <el-table-column prop="beforeDepart" label="调动前部门" align="center" />
            <el-table-column
                    prop="statys"
                    label="状态"
                    align="center">
...
<script>
    export default {
        ...
        methods: {
            ...
            agree(id) {
                this.putRequest("/api/admin/approve/transdepart/?id="+ id + '&status=1')
                    .then((data) => {
                        if (data) {
                            this.listTransDeparts();
                        }
            ...
            refuse(id) {
                this.putRequest("/api/admin/approve/transdepart/?id="+ id + '&status=2')
                    .then((data) => {
                        if (data) {
                            this.listTransDeparts();
                        }
